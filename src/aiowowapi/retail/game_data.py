...
class GameData:
    ...
    def __init__(self, api):
        """This class contains all API endpoints for the GameData category of
        the Retail World of Warcraft API
    ...
    async def get_game_api_resource(self,
        ...
        :type namespace: str
        :param endpoint: The API endpoint of the resource we're trying to
            access
        :type endpoint: str
    ...
    # For some reason this API endpoint isn't documented on the
    # Blizzard API website, so for now it's added manually
    async def get_commodity_auctions(self):
        """Returns all active commodity auctions for a region.
        Auction house data updates at a set interval. The value was initially
        set at 1 hour; however, it might change over time without notice.
        Depending on the number of active auctions on the region, the response
    ...
    async def get_achievement_category(self,
        ...
        endpoint = f"/data/wow/achievement-category/" + \
                   f"{achievement_category_id}"
        namespace = "static-{region}"
    ...
    async def get_achievement(self,
        ...
        endpoint = f"/data/wow/achievement/" + \
                   f"{achievement_id}"
        namespace = "static-{region}"
    ...
    async def get_achievement_media(self,
        ...
        endpoint = f"/data/wow/media/achievement/" + \
                   f"{achievement_id}"
        namespace = "static-{region}"
    ...
    async def get_auctions(self,
        ...
        """Returns all active auctions for a connected realm.  See the
        Connected Realm API for information about retrieving
        a list of connected realm IDs.  Auction house data
        updates at a set interval. The value was initially
        set at 1 hour; however, it might change over time
        without notice.  Depending on the number of active
        auctions on the specified connected realm, the
        response from this endpoint may be rather large,
        ...
        endpoint = f"/data/wow/connected-realm/" + \
    ...
    async def get_azerite_essence(self,
        ...
        endpoint = f"/data/wow/azerite-essence/" + \
                   f"{azerite_essence_id}"
        namespace = "static-{region}"
    ...
    async def get_azerite_essence_search(self,
        ...
        """Performs a search of azerite essences. The fields below are
        provided for example. For more detail see the Search
        Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of azerite essences
        """
    ...
    async def get_azerite_essence_media(self,
        ...
        endpoint = f"/data/wow/media/azerite-essence/" + \
                   f"{azerite_essence_id}"
        namespace = "static-{region}"
    ...
    async def get_connected_realms_search(self,
        ...
        """Performs a search of connected realms. The fields below are
        provided for example. For more detail see the Search
        Guide.
    ...
    async def get_covenant_media(self,
        ...
        endpoint = f"/data/wow/media/covenant/" + \
                   f"{covenant_id}"
        namespace = "static-{region}"
    ...
    async def get_soulbind(self,
        ...
        endpoint = f"/data/wow/covenant/soulbind/" + \
                   f"{soulbind_id}"
        namespace = "static-{region}"
    ...
    async def get_conduit(self,
        ...
        endpoint = f"/data/wow/covenant/conduit/" + \
                   f"{conduit_id}"
        namespace = "static-{region}"
    ...
    async def get_creature_family(self,
        ...
        endpoint = f"/data/wow/creature-family/" + \
                   f"{creature_family_id}"
        namespace = "static-{region}"
    ...
    async def get_creature_type(self,
        ...
        endpoint = f"/data/wow/creature-type/" + \
                   f"{creature_type_id}"
        namespace = "static-{region}"
    ...
    async def get_creature_search(self,
        ...
        """Performs a search of creatures. The fields below are
        provided for example. For more detail see the Search
        Guide.
    ...
    async def get_creature_display_media(self,
        ...
        endpoint = f"/data/wow/media/creature-display/" + \
                   f"{creature_display_id}"
        namespace = "static-{region}"
    ...
    async def get_creature_family_media(self,
        ...
        endpoint = f"/data/wow/media/creature-family/" + \
                   f"{creature_family_id}"
        namespace = "static-{region}"
    ...
    async def get_guild_crest_border_media(self,
        ...
        endpoint = f"/data/wow/media/guild-crest/border/" + \
                   f"{border_id}"
        namespace = "static-{region}"
    ...
    async def get_guild_crest_emblem_media(self,
        ...
        endpoint = f"/data/wow/media/guild-crest/emblem/" + \
                   f"{emblem_id}"
        namespace = "static-{region}"
    ...
    async def get_item_class(self,
        ...
        endpoint = f"/data/wow/item-class/" + \
                   f"{item_class_id}"
        namespace = "static-{region}"
    ...
    async def get_item_media(self,
        ...
        endpoint = f"/data/wow/media/item/" + \
                   f"{item_id}"
        namespace = "static-{region}"
    ...
    async def get_item_search(self,
        ...
        """Performs a search of items. The fields below are provided
        for example. For more detail see the Search Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of items
        """
    ...
    async def get_journal_expansion(self,
        ...
        endpoint = f"/data/wow/journal-expansion/" + \
                   f"{journal_expansion_id}"
        namespace = "static-{region}"
    ...
    async def get_journal_encounter(self,
        ...
        endpoint = f"/data/wow/journal-encounter/" + \
                   f"{journal_encounter_id}"
        namespace = "static-{region}"
    ...
    async def get_journal_encounter_search(self,
        ...
        """Performs a search of journal encounters. The fields below
        are provided for example. For more detail see the
        Search Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of journal encounters
        """
    ...
    async def get_journal_instance(self,
        ...
        endpoint = f"/data/wow/journal-instance/" + \
                   f"{journal_instance_id}"
        namespace = "static-{region}"
    ...
    async def get_journal_instance_media(self,
        ...
        endpoint = f"/data/wow/media/journal-instance/" + \
                   f"{journal_instance_id}"
        namespace = "static-{region}"
    ...
    async def get_media_search(self,
        ...
        """Performs a search of all types of media documents. The
        fields below are provided for example. For more
        detail see the Search Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of all types of media documents
        """
    ...
    async def get_modified_crafting_category(self,
        ...
        endpoint = f"/data/wow/modified-crafting/category/" + \
                   f"{category_id}"
        namespace = "static-{region}"
    ...
    async def get_modified_crafting_reagent_slot_type(self,
        ...
        endpoint = f"/data/wow/modified-crafting/reagent-slot-type/" + \
                   f"{slot_type_id}"
        namespace = "static-{region}"
    ...
    async def get_mount_search(self,
        ...
        """Performs a search of mounts. The fields below are provided
        for example. For more detail see the Search Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of mounts
        """
    ...
    async def get_mythic_keystone_affix(self,
        ...
        endpoint = f"/data/wow/keystone-affix/" + \
                   f"{keystone_affix_id}"
        namespace = "static-{region}"
    ...
    async def get_mythic_keystone_affix_media(self,
        ...
        endpoint = f"/data/wow/media/keystone-affix/" + \
                   f"{keystone_affix_id}"
        namespace = "static-{region}"
    ...
    async def get_mythic_keystone_dungeon(self,
        ...
        endpoint = f"/data/wow/mythic-keystone/dungeon/" + \
                   f"{dungeon_id}"
        namespace = "dynamic-{region}"
    ...
    async def get_mythic_keystone_index(self):
        """Returns an index of links to other documents related to
        Mythic Keystone dungeons.

        :return: Returns an index of links to other documents related to
            Mythic Keystone dungeons.
        """
    ...
    async def get_mythic_keystone_period(self,
        ...
        endpoint = f"/data/wow/mythic-keystone/period/" + \
                   f"{period_id}"
        namespace = "dynamic-{region}"
    ...
    async def get_mythic_keystone_season(self,
        ...
        endpoint = f"/data/wow/mythic-keystone/season/" + \
                   f"{season_id}"
        namespace = "dynamic-{region}"
    ...
    async def get_mythic_keystone_leaderboards_index(self,
        ...
        """Returns an index of Mythic Keystone Leaderboard dungeon
        instances for a connected realm.

        :param connected_realm_id: The ID of the connected realm.
        :type connected_realm_id: int
        :return: Returns an index of Mythic Keystone Leaderboard dungeon
            instances for a connected realm.
        """

        endpoint = f"/data/wow/connected-realm/" + \
                   f"{connected_realm_id}/mythic-leaderboard/index"
        namespace = "dynamic-{region}"
    ...
    async def get_mythic_keystone_leaderboard(self,
        ...
        endpoint = f"/data/wow/connected-realm/" + \
                   f"{connected_realm_id}/mythic-leaderboard/" + \
                   f"{dungeon_id}/period/" + \
                   f"{period}"
        namespace = "dynamic-{region}"
    ...
    async def get_mythic_raid_leaderboard(self,
        ...
        endpoint = f"/data/wow/leaderboard/hall-of-fame/" + \
                   f"{raid}/" + \
                   f"{faction}"
        namespace = "dynamic-{region}"
    ...
    async def get_pet_ability(self,
        ...
        endpoint = f"/data/wow/pet-ability/" + \
                   f"{pet_ability_id}"
        namespace = "static-{region}"
    ...
    async def get_pet_ability_media(self,
        ...
        endpoint = f"/data/wow/media/pet-ability/" + \
                   f"{pet_ability_id}"
        namespace = "static-{region}"
    ...
    async def get_playable_class(self,
        ...
        endpoint = f"/data/wow/playable-class/" + \
                   f"{class_id}"
        namespace = "static-{region}"
    ...
    async def get_playable_class_media(self,
        ...
        endpoint = f"/data/wow/media/playable-class/" + \
                   f"{playable_class_id}"
        namespace = "static-{region}"
    ...
    async def get_playable_race(self,
        ...
        endpoint = f"/data/wow/playable-race/" + \
                   f"{playable_race_id}"
        namespace = "static-{region}"
    ...
    async def get_playable_specialization(self,
        ...
        endpoint = f"/data/wow/playable-specialization/" + \
                   f"{spec_id}"
        namespace = "static-{region}"
    ...
    async def get_playable_specialization_media(self,
        ...
        endpoint = f"/data/wow/media/playable-specialization/" + \
                   f"{spec_id}"
        namespace = "static-{region}"
    ...
    async def get_power_type(self,
        ...
        endpoint = f"/data/wow/power-type/" + \
                   f"{power_type_id}"
        namespace = "static-{region}"
    ...
    async def get_profession(self,
        ...
        endpoint = f"/data/wow/profession/" + \
                   f"{profession_id}"
        namespace = "static-{region}"
    ...
    async def get_profession_media(self,
        ...
        endpoint = f"/data/wow/media/profession/" + \
                   f"{profession_id}"
        namespace = "static-{region}"
    ...
    async def get_recipe_media(self,
        ...
        endpoint = f"/data/wow/media/recipe/" + \
                   f"{recipe_id}"
        namespace = "static-{region}"
    ...
    async def get_pvp_season(self,
        ...
        endpoint = f"/data/wow/pvp-season/" + \
                   f"{pvp_season_id}"
        namespace = "dynamic-{region}"
    ...
    async def get_pvp_leaderboards_index(self,
        ...
        endpoint = f"/data/wow/pvp-season/" + \
                   f"{pvp_season_id}/pvp-leaderboard/index"
        namespace = "dynamic-{region}"
    ...
    async def get_pvp_leaderboard(self,
        ...
        """Returns the PvP leaderboard of a specific PvP bracket for a
        PvP season.
        ...
        :return: Returns the PvP leaderboard of a specific PvP bracket for a
            PvP season.
        """

        endpoint = f"/data/wow/pvp-season/" + \
                   f"{pvp_season_id}/pvp-leaderboard/" + \
                   f"{pvp_bracket}"
        namespace = "dynamic-{region}"
    ...
    async def get_pvp_rewards_index(self,
        ...
        endpoint = f"/data/wow/pvp-season/" + \
                   f"{pvp_season_id}/pvp-reward/index"
        namespace = "dynamic-{region}"
    ...
    async def get_pvp_tier_media(self,
        ...
        endpoint = f"/data/wow/media/pvp-tier/" + \
                   f"{pvp_tier_id}"
        namespace = "static-{region}"
    ...
    async def get_quest_categories_index(self):
        """Returns an index of quest categories (such as quests for a
        specific class, profession, or storyline).

        :return: Returns an index of quest categories (such as quests for a
            specific class, profession, or storyline).
        """
    ...
    async def get_quest_category(self,
        ...
        endpoint = f"/data/wow/quest/category/" + \
                   f"{quest_category_id}"
        namespace = "static-{region}"
    ...
    async def get_quest_area(self,
        ...
        endpoint = f"/data/wow/quest/area/" + \
                   f"{quest_area_id}"
        namespace = "static-{region}"
    ...
    async def get_quest_types_index(self):
        """Returns an index of quest types (such as PvP quests, raid
        quests, or account quests).

        :return: Returns an index of quest types (such as PvP quests, raid
            quests, or account quests).
        """
    ...
    async def get_quest_type(self,
        ...
        endpoint = f"/data/wow/quest/type/" + \
                   f"{quest_type_id}"
        namespace = "static-{region}"
    ...
    async def get_realm_search(self,
        ...
        """Performs a search of realms. The fields below are provided
        for example. For more detail see the Search Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of realms
        """
    ...
    async def get_reputation_faction(self,
        ...
        endpoint = f"/data/wow/reputation-faction/" + \
                   f"{reputation_faction_id}"
        namespace = "static-{region}"
    ...
    async def get_reputation_tiers(self,
        ...
        endpoint = f"/data/wow/reputation-tiers/" + \
                   f"{reputation_tiers_id}"
        namespace = "static-{region}"
    ...
    async def get_spell_media(self,
        ...
        endpoint = f"/data/wow/media/spell/" + \
                   f"{spell_id}"
        namespace = "static-{region}"
    ...
    async def get_spell_search(self,
        ...
        """Performs a search of spells. The fields below are provided
        for example. For more detail see the Search Guide.

        :param search_params: Search parameters
        :type search_params: dict
        :return: Performs a search of spells
        """
    ...
    async def get_pvp_talent(self,
        ...
        endpoint = f"/data/wow/pvp-talent/" + \
                   f"{pvp_talent_id}"
        namespace = "static-{region}"
    ...
    async def get_tech_talent_tree(self,
        ...
        endpoint = f"/data/wow/tech-talent-tree/" + \
                   f"{tech_talent_tree_id}"
        namespace = "static-{region}"
    ...
    async def get_tech_talent(self,
        ...
        endpoint = f"/data/wow/tech-talent/" + \
                   f"{tech_talent_id}"
        namespace = "static-{region}"
    ...
    async def get_tech_talent_media(self,
        ...
        endpoint = f"/data/wow/media/tech-talent/" + \
                   f"{tech_talent_id}"
        namespace = "static-{region}"
