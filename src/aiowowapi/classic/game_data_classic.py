...
class GameData:
    def __init__(self, api):
        ...
        the Classic World of Warcraft API
    ...
    async def get_game_api_resource(self,
        ...
        """Generic method for retrieving data from a Classic Game Data
        API endpoint
    ...
    async def get_auction_house_index(self,
        ...
        See the Connected Realm API for information about
        retrieving a list of connected realm IDs.
        ...
        endpoint = f"/data/wow/connected-realm/" + \
                   f"{connected_realm_id}/auctions/index"
    ...
    async def get_auctions(self,
        ...
        """Returns all active auctions for a specific auction house on
        a connected realm.  See the Connected Realm API for
        information about retrieving a list of connected
        realm IDs.  Auction house data updates at a set
        interval. The value was initially set at 1 hour;
        however, it might change over time without notice.
        Depending on the number of active auctions on the
        specified connected realm, the response from this
        endpoint may be rather large, sometimes exceeding 10
        MB.
        ...
        :return: Returns all active auctions for a specific auction house on
            a connected realm.
        """
    ...
    async def get_pvp_regional_season_index(self,
        ...
        endpoint = f"/data/wow/pvp-region/" + \
                   f"{pvp_region_id}/pvp-season/index"
        namespace = "dynamic-classic-{region}"
    ...
    async def get_pvp_leaderboards_index(self,
        ...
        """Returns an index of PvP leaderboards for a PvP season in a
        given PvP region.
        ...
        :param pvp_season_id: The ID of the PvP season.
        :type pvp_season_id: int
        :return: Returns an index of PvP leaderboards for a PvP season in a
            given PvP region.
        """
    ...
    async def get_pvp_leaderboard(self,
        ...
        PvP season in a given PvP region.
    ...
    async def get_pvp_rewards_index(self,
        ...
        :param pvp_season_id: The ID of the PvP season.
        :type pvp_season_id: int
        :return: Returns an index of PvP rewards for a PvP season in a given
            PvP region.
        """
    ...
    async def get_realm_search(self,
        ...
        """Performs a search of realms. The fields below are examples
        only. For more detail see the Search Guide.
